...
public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        { "async_completion_depth",
          ...
          "1" },
        { "architecture_adapter", "Explicit architecture adapter; empty or coldfire-v4e.", "" },
        { "platform_machine", "Expected QEMU machine name for the selected adapter.", "" },
        { "cache_native_regions", "Native shared RAM base:size pairs separated by semicolons; maximum two 64-KiB regions.", "" },
        { "sst_window_cache",
          "Opt-in private ColdFire supervisor data cache per CPU for registered native RAM "
